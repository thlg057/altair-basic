...
# Source files
SRCS = main.c basic_repl.c error.c memory.c program.c
...
$(TEST_TARGET): $(BUILD_DIR)/basic_repl.o $(BUILD_DIR)/error.o $(BUILD_DIR)/memory.o $(BUILD_DIR)/program.o $(TEST_OBJS)
	$(CC) $(CFLAGS) -o $@ $^
	strip $@
